...
getPopoverWater({ id: props.info.id }).then(res => {
  ...
  >
    <div class="indicator">
      <div class="item">
        ...
        <div class="value">{{ state.detail?.waterLevel }} m³/s</div>
      </div>
      <div class="item">
